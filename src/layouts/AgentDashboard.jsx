...
import { BsBuildingAdd, BsBuildingCheck, BsBuildingExclamation } from "react-icons/bs";
...
const AgentDashboard = () => {
  ...
  return (
    <>
      <div className="w-full h-screen grid grid-cols-[20%_80%]">
        <div className="fixed top-0 left-0 w-1/5 h-full bg-[#181818] py-10 px-5">
          ...
          <div className="flex items-center w-full justify-between mt-5">
            <button onClick={logOut} className="flex items-center gap-2 text-[#F10A0A]">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M13 17L14 17C14.7956 17 15.5587 16.6839 16.1213 16.1213C16.6839 15.5587 17 14.7956 17 14L17 4C17 3.20435 16.6839 2.44129 16.1213 1.87868C15.5587 1.31607 14.7956 1 14 1L13 1M5 5L1 9M1 9L5 13M1 9L13 9" stroke="#F10A0A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <span>Logout</span>
            </button>
