  ...
  return (
    <>
      <div className="w-full h-screen lg:grid lg:grid-cols-[20%_80%]">
        ...
        <div className={`fixed lg:static top-0 left-0 w-full  h-full bg-[#181818] py-10 px-5 md:px-3 lg:px-5 overflow-y-auto transform transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 z-20`}>
