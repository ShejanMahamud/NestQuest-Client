...
const Services = () => {
  return (
    <div className="w-full bg-[#D4D4D4] p-20 flex items-center flex-col justify-center">
      <h1 className="text-[#2B2B2B] text-xl font-medium mb-3">OUR SERVICES</h1>
      <p className="text-[#0B090A] text-2xl font-bold">We always strive to provide the best services</p>
      <div className="w-full grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 row-auto items-stretch gap-10 mt-16">
        <div className="flex w-full flex-col items-center justify-center gap-3 bg-white rounded-lg p-10">
        ...
        <div className="flex w-full flex-col items-center gap-3 bg-white rounded-lg p-10">
          <div className="bg-[#4361EE] h-20 w-20 rounded-full drop-shadow-custom mb-5 flex items-center justify-center">
